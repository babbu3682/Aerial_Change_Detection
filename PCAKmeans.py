...
def find_PCAKmeans(imagepath1, imagepath2):
    ...
    print("뭘까요1", image1.shape)

    image2 = imread(imagepath2)
    # image2 = np.mean(image2,2)
    print("뭘까요2", image2.shape)

    print("체크포인트", image1.shape,image2.shape) 
